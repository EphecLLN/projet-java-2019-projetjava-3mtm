...
public class Console extends Vue implements Observer {
	...
	private class ReadInput implements Runnable{
		...
		/*
		 * x , y, x2 ,y2 sont des intergers entre 0 et 8
		 * x et yelle represente les coordonnées de la piece que nous voulons deplacer
		 * x2 et y2 represente les coordonnées de la casse de destination
		 */
		public void run() {
